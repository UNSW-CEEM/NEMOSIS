...
from nemosis. downloader import download_csv, download_elements_file, download_xml
...
static_downloader_map = {
    "VARIABLES_FCAS_4_SECOND": download_csv,
    "ELEMENTS_FCAS_4_SECOND": download_elements_file,
    "Generators and Scheduled Loads": download_xml,
    "_downloader.download_xml": download_xml,
}
