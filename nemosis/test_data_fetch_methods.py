...
class TestStaticTables(unittest.TestCase):
    ...
    def test_fcas_elements_table(self):
        ...
        data = data_fetch_methods._static_table_FCAS_elements_file_wrapper_for_gui(start_time, end_time,
    ...
    def test_fcas_variable_table(self):
        ...
        data = data_fetch_methods._static_table_wrapper_for_gui(start_time, end_time,
                                               table, defaults.raw_data_cache,
                                               select_columns=cols, filter_cols=filter_cols,
                                                filter_values=(['2'],))
        expected_length = 1
