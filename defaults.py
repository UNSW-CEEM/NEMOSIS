...
display_in_gui = ['DISPATCHLOAD', 'DUDETAILSUMMARY', 'DISPATCHCONSTRAINT', 'GENCONDATA', 'DISPATCH_UNIT_SCADA',
                  ...
                  'BIDPEROFFER_D', 'BIDPEROFFER', 'DISPATCHINTERCONNECTORRES', 'BIDDAYOFFER_D', 'BIDDAYOFFER',
                  'DISPATCHREGIONSUM', 'FCAS_4_SECOND','ELEMENTS_FCAS_4_SECOND', 'VARIABLES_FCAS_4_SECOND',
                  'Generators and Scheduled Loads', 'FCAS_4s_SCADA_MAP']
...
table_columns = {
    ...
    'BIDPEROFFER': ['DUID', 'BANDAVAIL1', 'BANDAVAIL2', 'BANDAVAIL3', 'BANDAVAIL4', 'BANDAVAIL5', 'BANDAVAIL6',
                      'BANDAVAIL7', 'BANDAVAIL8', 'BANDAVAIL9', 'BANDAVAIL10', 'MAXAVAIL', 'RAMPUPRATE',
                      'RAMPDOWNRATE', 'BIDTYPE', 'SETTLEMENTDATE', 'ENABLEMENTMIN', 'ENABLEMENTMAX', 'LOWBREAKPOINT',
                      'HIGHBREAKPOINT', 'PERIODID', 'OFFERDATE'],
    ...
    'BIDDAYOFFER': ['SETTLEMENTDATE', 'DUID', 'BIDTYPE', 'OFFERDATE', 'VERSIONNO', 'PRICEBAND1', 'PRICEBAND2',
                      'PRICEBAND3', 'PRICEBAND4', 'PRICEBAND5', 'PRICEBAND6', 'PRICEBAND7', 'PRICEBAND8',
...
table_primary_keys = {'DISPATCHCONSTRAINT': ['CONSTRAINTID', 'GENCONID_EFFECTIVEDATE', 'GENCONID_VERSIONNO',
                      ...
                      'BIDPEROFFER': ['BIDTYPE', 'DUID', 'OFFERDATE', 'PERIODID', 'SETTLEMENTDATE'],
                      ...
                      'BIDDAYOFFER': ['BIDTYPE', 'DUID', 'SETTLEMENTDATE'],
