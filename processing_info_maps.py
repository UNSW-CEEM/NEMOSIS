...
setup = {'DISPATCHLOAD': None,
         ...
         'BIDPEROFFER_D': None,
         'BIDDAYOFFER': query_wrapers.dispatch_date_setup,
         'BIDPEROFFER': None,
...
search_type = {'DISPATCHLOAD': 'start_to_end',
               ...
               'BIDDAYOFFER': 'start_to_end',
               'BIDPEROFFER': 'start_to_end',
               'FCAS_4s_SCADA_MAP': None,
...
filter = {'DISPATCHLOAD': filters.filter_on_settlementdate,
          ...
          'BIDDAYOFFER': filters.filter_on_settlementdate,
          'BIDPEROFFER': filters.filter_on_date_and_peroid,
          'FCAS_4s_SCADA_MAP': None,
